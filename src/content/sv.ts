...
export const sv: SiteContent = {
  ...
  hero: {
    ...
    subline:
      "Fullservice kortids- och långtidsuthyrning i Marbella, Mijas, Fuengirola, Benalmádena, Torremolinos och Málaga — positionering, prissättning och presentation, ständigt förfinade.",
  ...
  system: {
    ...
    heading: "Vad kan du förvänta dig av oss?",
    intro:
  ...
  portfolio: {
    ...
    disclaimer: "Verkliga före/efter-foton och verkliga tillväxtsiffror från våra egna fastigheter.",
    beforeLabel: "Före",
    afterLabel: "Efter",
    properties: [
      {
  ...
  about: {
    ...
    founderQuote:
      "Vi driver inte bara en annons — vi bygger och formar en fastighet som faktiskt konverterar. Vi känner marknaden på Costa del Sol, och vi känner gästerna, särskilt de skandinaviska gästerna som bokar här.",
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        quote:
          "Sköter det bättre än jag gjorde själv, och jag brukade förvalta tre fastigheter.",
        name: "Erik B.",
        location: "Mijas",
      },
      {
        quote:
          "Var skeptisk till att lämna ifrån mig allt, men rapporteringen är mer detaljerad än det jag får från min redovisningskonsult. Jag ser beläggning, städning, allt.",
        name: "Sofia T.",
        location: "Marbella",
      },
      {
        quote:
          "Vi ärvde mina föräldrars lägenhet och visste inte vad vi skulle göra med den. Nordic BnB fotograferade den, listade om den, och inom sex veckor hade vi våra första bokningar. Ett år senare presterar den bättre än liknande enheter i närheten, och jag har aldrig behövt hantera en gäst direkt.",
        name: "Henrik J.",
        location: "Fuengirola",
      },
      {
        quote:
          "Snabba att svara, och städningen är verkligen felfri varje gång.",
        name: "Maja P.",
        location: "Benalmádena",
      },
      {
        quote:
          "Bytte från en annan byrå som knappt kommunicerade. Nordic BnB ringer faktiskt när något kräver ett beslut, istället för att bara hantera det tyst och hoppas att jag inte märker det.",
        name: "Thomas R.",
        location: "Marbella",
      },
      {
        quote:
          "Hyrde ut långsiktigt tidigare. Hyresgästen lämnade stället i dåligt skick och jag förlorade två månaders inkomst på att rätta till det. Nu är det korttidsuthyrning via Nordic BnB, och även med extra städning mellan gäster tjänar jag mer än med en enda hyresgäst.",
        name: "Ingrid S.",
        location: "Mijas",
      },
      {
        quote:
          "Fullbokat de flesta helger innan jag ens hunnit klart med överlämningspapperen.",
        name: "Daniel K.",
        location: "Torremolinos",
      },
      {
        quote:
          "Min villa stod tom halva året under den gamla annonsen. Nu är den sällan ledig mer än några dagar i taget, och bilderna ser faktiskt ut som mitt hus.",
        name: "Camilla W.",
        location: "Fuengirola",
      },
      {
        quote:
          "Det som övertygade mig var prissättningen. Jag brukade sätta ett pris och glömma det. De justerar dagligen efter efterfrågan, och jag ser exakt varför i månadsrapporten. Intäkterna har ökat med nästan en tredjedel sedan jag bytte.",
        name: "Anders G.",
        location: "Benalmádena",
      },
    ],
  ...
  contactPage: {
    ...
    intro:
      "Vi följer upp din fastighet varje dag — tillsammans med vårt eget fasta team. Hör gärna av dig direkt.",
    ...
    recruitHeading: "Vill du jobba med oss?",
    recruitSubline:
      "Vi är alltid öppna för bra folk. Är du städare, handyman eller fotograf på Costa del Sol hör vi gärna av dig.",
    story: {
      eyebrow: "Vår historia",
      heading: "Från marknadsföring till gästfrihet.",
      milestones: [
        {
          period: "Augusti 2023",
          title: "Där det började",
          body: "Nordic BnB startade i Norge med digital marknadsföring och hjälpte företag och fastighetsinvesterare att presentera sig själva — och sina fastigheter — bättre online. Det lärde oss en sak tidigt: presentation förändrar uppfattning, och uppfattning förändrar värde.",
        },
        {
          period: "2024",
        ...
        {
          period: "Sent 2025",
          title: "Idén utvecklades",
          body: "Vi började kombinera allt vi redan kunde — marknadsföring, presentation, inredning, gästupplevelse och praktisk uthyrningsförvaltning — till en komplett tjänst för ägare av semesteruthyrning, byggd på det vi lärt oss av att hjälpa investerare skapa värde av sina fastigheter, i både Norge och Spanien.",
        },
        {
          period: "2026",
          title: "Nordic BnB idag",
          body: "Nordic BnB blev ett fullservicebolag för semesteruthyrning och fastighetsförvaltning på Costa del Sol. Från att förbereda och uppgradera fastigheten till styling, fotografering, annonser, prissättning, gästkommunikation, städning, underhåll och full förvaltning. Ett bolag. En kontaktpunkt. Allt hanterat.",
        },
        {
          period: "2026 →",
          title: "Nästa kapitel",
          body: "Vårt mål är enkelt: bygga en ny standard för semesteruthyrningsförvaltning på Costa del Sol — som kombinerar skandinavisk service, stark presentation och lokalt genomförande. Vi uppgraderar. Vi stylar. Vi förvaltar.",
        },
      ],
    },
  },
  privacyPage: {
    ...
    intro:
      "Den här sidan förklarar, i enkla ord, vilken information Nordic BnB samlar in när du kontaktar oss och hur vi använder den.",
    sections: [
      {
        heading: "Vad vi samlar in",
        body: "När du hör av dig via vårt kontaktformulär, e-post eller WhatsApp samlar vi in de uppgifter du lämnar — vanligtvis namn, e-postadress, telefonnummer och information om din fastighet eller förfrågan.",
      },
      {
        heading: "Hur vi använder det",
        body: "Vi använder denna information endast för att svara på din förfrågan, ge en fastighetsgenomgång eller offert, och om du blir kund, för att förvalta din fastighet och kommunicera med dig om den. Vi säljer inte din information till tredje part.",
      },
      {
        heading: "Hur länge vi sparar det",
        body: "Vi sparar förfrågningsinformation så länge det behövs för att svara dig, eller om du blir kund, under vår samarbetsperiod och därefter så länge lagen kräver.",
      },
      {
        heading: "Dina rättigheter",
        body: "Du kan när som helst fråga oss vilken information vi har om dig, be oss rätta den, eller begära att vi raderar den. Maila oss bara så ordnar vi det.",
      },
    ],
    contactHeading: "Frågor om din data?",
    contactBody: "För personuppgiftsrelaterade förfrågningar, maila oss direkt så svarar vi dig personligen.",
  },
};
